...
public class SseServiceImpl implements SseService {
    ...
    public SseEmitter subscribeRestaurant(Long restaurantId) {
        SseEmitter emitter = createEmitter(restaurantId, restaurantEmitters, "Restaurant");
        return emitter;
    }

    @Override
    public SseEmitter subscribeShipper(Long shipperId) {
        SseEmitter emitter = createEmitter(shipperId, shipperEmitters, "Shipper");
        return emitter;
    }
    ...
    private SseEmitter createEmitter(Long id, Map<Long, SseEmitter> emittersMap, String type) {
        ...
        // Send a dummy event to establish connection successfully without timing out immediately
        try {
